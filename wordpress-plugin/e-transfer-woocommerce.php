        ...
        if (is_checkout()) {
            ...
            <script type="text/javascript">
                jQuery(document).ready(function($) {
                    ...
                    $('.woocommerce-checkout').on('input blur', '.input-text, select, textarea', function() {
                        var $field = $(this);
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="url" id="etransfer_backend_api_endpoint" name="etransfer_backend_api_endpoint"
                                   value="<?php echo esc_attr(get_option('etransfer_backend_api_endpoint', '')); ?>"
                                   class="regular-text" placeholder="https://api.example.com/orders" />
