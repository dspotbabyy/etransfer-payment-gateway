...
const EditAccount = ({ accountId, onSuccess, onCancel }) => {
        ...
        >
          ...
          <CardContent sx={{ p: 4 }}>
            <form onSubmit={handleSubmit}>
              ...
              {success && (
                <Alert severity="success" sx={{ mb: 3 }}>Account updated successfully!</Alert>
              )}
              ...
              <Box sx={{ display: 'flex', justifyContent: 'flex-end', gap: 2, mt: 3 }}>
                {onCancel && (
                  <Button onClick={onCancel} color="secondary" variant="outlined" disabled={updating}>
                    Cancel
                  </Button>
                )}
                <Button
